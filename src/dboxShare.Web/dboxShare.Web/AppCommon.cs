...
namespace dboxShare.Web
{
    ...
    public static class AppCommon
    {
        ...
        public static bool LoginAuth(string Sign)
        {
            try
            {
                string UserId = Context.Session["UserId"].TypeString();
                ...
                string LoginToken = Context.Session["LoginToken"].TypeString();
        ...
        public static string FileCodeId()
        {
            using (RNGCryptoServiceProvider RNG = new RNGCryptoServiceProvider())
            {
                ...
                int Result16 = BitConverter.ToInt16(Buffer, 0);
                int Result32 = BitConverter.ToInt32(Buffer, 0);
                ...
                Code.Add(new Random(Result16).Next(1000, 9999).ToString());
                Code.Add(new Random(Result32).Next(10000000, 99999999).ToString());
        ...
        public static string FileType(string Extension)
        {
            ...
            foreach (string Key in TypeTable.Keys)
            {
                ...
                {
                    string[] Extensions = TypeTable[Key].TypeString().Split(',');
        ...
        public static string FolderName(int FolderId, string FolderName, ref object Conn)
        {
            ...
            Query += "Select B.DS_Id From DS_File As B Inner Join DS_File_Purview On " +
                     ...
                     "DS_File.DS_Name Like '" + FolderName + "%' And " +
            ...
            string Sql = "Select DS_Folder, DS_FolderId, DS_Name From DS_File Where " + Query + " Order By DS_Id Desc";
            ...
            for (int i = 0; i < Folders.Count; i++)
            {
                ...
                {
                    int Value = Base.Common.StringGet(Folders[i].TypeString(), @"\s\((\d+)\)$").TypeInt();
        ...
        public static string FileName(int FolderId, string FileName, string FileExtension, ref object Conn)
        {
            ...
            Query += "Select B.DS_Id From DS_File As B Inner Join DS_File_Purview On " +
                     ...
                     "DS_File.DS_FolderId = " + FolderId + " And " +
                     "DS_File.DS_Share = 1 And " +
                     "DS_File.DS_Name Like '" + FileName + "%' And " +
                     "DS_File.DS_Extension = '" + FileExtension + "' And " +
                     "DS_File_Purview.DS_DepartmentId Like '" + Context.Session["DepartmentId"].TypeString() + "%' Union All ";
            ...
            string Sql = "Select DS_VersionId, DS_Folder, DS_FolderId, DS_Name, DS_Extension From DS_File Where " + Query + " Order By DS_Id Desc";
            ...
            for (int i = 0; i < Files.Count; i++)
            {
                ...
                {
                    int Value = Base.Common.StringGet(Files[i].TypeString(), @"\s\((\d+)\)$").TypeInt();
        ...
        public static int FileVersionNumber(int FileId, ref object Conn)
        {
            ...
            string Sql = "Select Top 1 DS_Id, DS_Version, DS_VersionId From DS_File Where " + Query + " Order By DS_Version Desc";
        ...
        public static void FileProcessorTrigger()
        {
            ...
            try
            {
                Directory.SetLastWriteTime(AppConfig.FileStoragePath, DateTime.Now);
            }
            catch (Exception) { }
        }
        ...
        public static void XmlDataReader(string FilePath, string Node, Hashtable Hashtable)
        {
            ...
            XmlNode XNodes = XDocument.SelectSingleNode(Node);
        ...
        {
            string FilePath = Base.Common.PathCombine(AppConfig.LogStoragePath, "error.log");
            ...
            using (FileStream FStream = new FileStream(FilePath, FileMode.Append, FileAccess.Write, FileShare.ReadWrite))
            {
