...
namespace dboxShare.Web.Drive.Controllers
{
    ...
    public class DiscussFlowListJsonController : ApiController
    {
        ...
        /// <summary>
        /// 读取讨论数据列表返回 JSON 格式字符串
        /// </summary>
        [Route("api/drive/discuss/flow-list-json")]
        [HttpGet]
        public HttpResponseMessage FlowListJson()
        {
            ...
            {
                Query += "Select A.DS_Id From DS_Discuss As A Inner Join DS_File On " +
                         "DS_File.DS_Id = A.DS_FileId Where " +
                         "A.DS_Id = DS_Discuss.DS_Id And " +
                         "A.DS_Revoke = 0 And " +
            ...
            Query += "Not Exists (Select E.DS_Id From DS_Discuss As E Where " +
                     "E.DS_Id = DS_Discuss.DS_Id And " +
                     "E.DS_UserId = " + Context.Session["UserId"].TypeString() + " And " +
                     "E.DS_Revoke = 0)";
            ...
            try
            {
                ...
                string Json = Base.Data.SqlPageToJson("DS_Discuss", "DS_Id, DS_FileId, DS_FileName, DS_FileExtension, DS_IsFolder, DS_UserId, DS_Username, DS_Content, DS_Time", "DS_Id Desc", Query, 50, Page, ref Conn);
