...
namespace dboxShare.Web.Drive.Controllers
{
    ...
    public class Drive_FolderDataJsonController : ApiController
    {
        ...
        public HttpResponseMessage DataJson()
        {
            ...
            try
            {
                ...
                var Json = Base.Data.SqlDataToJson("Select DS_Id, DS_Username, DS_Folder, DS_FolderId, DS_Name, DS_Remark, DS_Share, DS_Lock, DS_CreateUsername, DS_CreateTime, DS_UpdateUsername, DS_UpdateTime, DS_RemoveUsername, DS_RemoveTime From DS_File Where DS_Folder = 1 And DS_Id = " + Id, ref Conn);
