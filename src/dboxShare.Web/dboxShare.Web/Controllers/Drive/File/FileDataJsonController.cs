...
namespace dboxShare.Web.Drive.Controllers
{
    ...
    public class Drive_FileDataJsonController : ApiController
    {
        ...
        public HttpResponseMessage DataJson()
        {
            ...
            try
            {
                ...
                var Json = Base.Data.SqlDataToJson("Select DS_Id, DS_Username, DS_Version, DS_Folder, DS_FolderId, DS_Name, DS_Extension, DS_Size, DS_Remark, DS_Share, DS_Lock, DS_CreateUsername, DS_CreateTime, DS_UpdateUsername, DS_UpdateTime, DS_RemoveUsername, DS_RemoveTime From DS_File Where DS_Folder = 0 And DS_Id = " + Id, ref Conn);
