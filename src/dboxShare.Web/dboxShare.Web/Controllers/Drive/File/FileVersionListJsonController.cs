...
namespace dboxShare.Web.Drive.Controllers
{
    ...
    public class Drive_FileVersionListJsonController : ApiController
    {
        ...
        public HttpResponseMessage VersionListJson()
        {
            ...
            var Myself = Context.Request.QueryString["Myself"].TypeString() == "true" ? true : false;
            ...
            try
            {
                ...
                var Json = Base.Data.SqlPageToJson("DS_File", "DS_Id, DS_Version, DS_VersionId, DS_Folder, DS_CodeId, DS_Name, DS_Extension, DS_Remark, DS_Share, DS_Lock, DS_Recycle, DS_CreateUsername, DS_CreateTime, DS_UpdateUsername, DS_UpdateTime", "DS_Id Desc", Query, 50, Page, ref Conn);
