...
namespace dboxShare.Web.Drive.Controllers
{
    ...
    public class Drive_ActivityLogListJsonController : ApiController
    {
        ...
        public HttpResponseMessage LogListJson()
        {
            ...
            try
            {
                ...
                var Json = Base.Data.SqlPageToJson("DS_Log", "DS_Id, DS_FileId, DS_FileName, DS_FileVersion, DS_UserId, DS_Username, DS_Action, DS_IP, DS_Time", "DS_Id Desc", Query, 50, Page, ref Conn);
