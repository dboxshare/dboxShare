...
namespace dboxShare.Web.Drive.Controllers
{
    ...
    public class Drive_PurviewListJsonController : ApiController
    {
        ...
        public HttpResponseMessage ListJson()
        {
            ...
            try
            {
                ...
                var Sql = "Select DS_FileId, DS_DepartmentId, DS_RoleId, DS_UserId, DS_Purview From DS_File_Purview Where DS_FileId = " + Id + " Order By DS_DepartmentId Asc, DS_RoleId Asc, DS_UserId Asc";
