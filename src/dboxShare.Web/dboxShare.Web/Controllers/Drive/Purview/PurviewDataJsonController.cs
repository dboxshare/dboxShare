...
namespace dboxShare.Web.Drive.Controllers
{
    ...
    public class PurviewDataJsonController : ApiController
    {
        ...
        public HttpResponseMessage DataJson()
        {
            ...
            try
            {
                ...
                string Json = Base.Data.SqlDataToJson("Select DS_Id, DS_Folder, DS_Share, DS_Sync From DS_File Where DS_Id = " + Id, ref Conn);
