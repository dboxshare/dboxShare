...
namespace dboxShare.Web.Drive.Controllers
{
    ...
    public class PurviewActionController : ApiController
    {
        ...
        public HttpResponseMessage Add()
        {
            ...
            string Type = Context.Request.Form["Type"].TypeString();
            ...
            try
            {
                ...
                for (int i = 0; i < Context.Request.Form.GetValues("TypeId").Length; i++)
                {
                    int TypeId = Context.Request.Form.GetValues("TypeId")[i].TypeInt();
        ...
        public HttpResponseMessage Modify()
        {
            ...
            string TypeId = Context.Request.Form["TypeId"].TypeString();
            ...
            string Purview = Context.Request.Form["Purview"].TypeString();
        ...
        public HttpResponseMessage Sync()
        {
            ...
            int Sync = Context.Request.Form["Sync"].TypeString() == "true" ? 1 : 0;
