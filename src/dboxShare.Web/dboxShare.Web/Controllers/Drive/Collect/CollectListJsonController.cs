...
namespace dboxShare.Web.Drive.Controllers
{
    ...
    public class Drive_CollectListJsonController : ApiController
    {
        ...
        /// </summary>
        [Route("api/drive/file/collect-list-json")]
        [HttpGet]
        public HttpResponseMessage CollectListJson()
        {
            ...
            var Join = "Inner Join DS_File_Collect On " + 
                       "DS_File_Collect.DS_FileId = DS_File.DS_Id And " + 
                       "DS_File_Collect.DS_UserId = " + Context.Session["UserId"].TypeString() + "";
