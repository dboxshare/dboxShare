...
namespace dboxShare.Web.Admin.Controllers
{
    ...
    public class UserListJsonController : ApiController
    {
        ...
        public HttpResponseMessage ListJson()
        {
            ...
            int DepartmentId = Context.Request.QueryString["DepartmentId"].TypeInt();

            int RoleId = Context.Request.QueryString["RoleId"].TypeInt();
            ...
            try
            {
                ...
                if (DepartmentId > 0)
                {
                    string DepartmentIdPath = AppCommon.DepartmentIdPath(DepartmentId, ref Conn);
                ...
                {
                    Query += "DS_Status = " + (Status == "job-on" ? 0 : -1) + " And ";
                }
                ...
                string Json = Base.Data.SqlPageToJson("DS_User", "DS_Id, DS_DepartmentId, DS_RoleId, DS_Username, DS_Title, DS_Email, DS_Phone, DS_Status, DS_Recycle", "DS_Username Asc, DS_Id Desc", Query, 50, Page, ref Conn);
