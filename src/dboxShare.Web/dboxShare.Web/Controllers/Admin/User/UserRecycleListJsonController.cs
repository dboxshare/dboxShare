...
namespace dboxShare.Web.Admin.Controllers
{
    ...
    public class Admin_UserRecycleListJsonController : ApiController
    {
        ...
        public HttpResponseMessage RecycleListJson()
        {
            ...
            try
            {
                ...
                var Json = Base.Data.SqlPageToJson("DS_User", "DS_Id, DS_DepartmentId, DS_RoleId, DS_Username, DS_Title, DS_Email, DS_Phone, DS_Freeze, DS_Recycle", "DS_Id Desc", Query, 50, Page, ref Conn);
