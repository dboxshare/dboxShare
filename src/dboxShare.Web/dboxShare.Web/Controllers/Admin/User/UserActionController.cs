...
namespace dboxShare.Web.Admin.Controllers
{
    ...
    public class UserActionController : ApiController
    {
        ...
        public HttpResponseMessage Add()
        {
            ...
            int RoleId = Context.Request.Form["RoleId"].TypeInt();
            ...
            string Code = Context.Request.Form["Code"].TypeString();
            ...
            string Title = Context.Request.Form["Title"].TypeString();
            ...
            int Admin = Context.Request.Form["Admin"].TypeString() == "true" ? 1 : 0;

            bool Send = Context.Request.Form["Send"].TypeString() == "true" ? true : false;
            ...
            try
            {
                ...
                string Sql = "Insert Into DS_User(DS_DepartmentId, DS_RoleId, DS_Username, DS_Password, DS_Code, DS_Title, DS_Email, DS_Phone, DS_Tel, DS_Admin, DS_Status, DS_Recycle, DS_Time, DS_LoginIP, DS_LoginTime) " +
                             "Values('" + DepartmentIdPath + "', " + RoleId + ", '" + Username + "', '" + PasswordMD5 + "', '" + Code + "', '" + Title + "', '" + Email + "', '" + Phone + "', '" + Tel + "', " + Admin + ", 0, 0, '" + DateTime.Now.ToString() + "', '0.0.0.0', '1970/1/1 00:00:00')";
        ...
        public HttpResponseMessage Create()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < Context.Request.Form.GetValues("Username").Length; i++)
                {
                    string Username = Context.Request.Form.GetValues("Username")[i].TypeString();
                    ...
                    string Password = Context.Request.Form.GetValues("Password")[i].TypeString();
                    ...
                    string Code = Context.Request.Form.GetValues("Code")[i].TypeString();
                    ...
                    string Title = Context.Request.Form.GetValues("Title")[i].TypeString();
                    ...
                    string Email = Context.Request.Form.GetValues("Email")[i].TypeString();
                    ...
                    string Phone = Context.Request.Form.GetValues("Phone")[i].TypeString();
                    ...
                    string Tel = Context.Request.Form.GetValues("Tel")[i].TypeString();
                    ...
                    string Sql = "Insert Into DS_User(DS_DepartmentId, DS_RoleId, DS_Username, DS_Password, DS_Code, DS_Title, DS_Email, DS_Phone, DS_Tel, DS_Admin, DS_Status, DS_Recycle, DS_Time, DS_LoginIP, DS_LoginTime) " +
                                 "Values('" + DepartmentIdPath + "', 0, '" + Username + "', '" + PasswordMD5 + "', '" + Code + "', '" + Title + "', '" + Email + "', '" + Phone + "', '" + Tel + "', 0, 0, 0, '" + DateTime.Now.ToString() + "', '0.0.0.0', '1970/1/1 00:00:00')";
        ...
        public HttpResponseMessage Modify()
        {
            ...
            int Status = Context.Request.Form["Freeze"].TypeString() == "true" ? -1 : 0;
            ...
            try
            {
                ...
                {
                    Sql = "Update DS_User Set DS_DepartmentId = '" + DepartmentIdPath + "', DS_RoleId = " + RoleId + ", DS_Code = '" + Code + "', DS_Title = '" + Title + "', DS_Email = '" + Email + "', DS_Phone = '" + Phone + "', DS_Tel = '" + Tel + "', DS_Admin = " + Admin + ", DS_Status = " + Status + " Where DS_Id = " + Id;
                }
                else
                {
                    string PasswordMD5 = Base.Common.StringHash(Password, "MD5");

                    Sql = "Update DS_User Set DS_DepartmentId = '" + DepartmentIdPath + "', DS_RoleId = " + RoleId + ", DS_Password = '" + PasswordMD5 + "', DS_Code = '" + Code + "', DS_Title = '" + Title + "', DS_Email = '" + Email + "', DS_Phone = '" + Phone + "', DS_Tel = '" + Tel + "', DS_Admin = " + Admin + ", DS_Status = " + Status + " Where DS_Id = " + Id;
                }
        ...
        public HttpResponseMessage Classify()
        {
            ...
            int ClassifyId = Context.Request.Form["ClassifyId"].TypeInt();

            string ClassifyType = Context.Request.Form["ClassifyType"].TypeString();
        ...
        public HttpResponseMessage Transfer()
        {
            ...
            int FromUserId = Context.Request.Form["FromUserId"].TypeInt();

            int ToUserId = Context.Request.Form["ToUserId"].TypeInt();
            ...
            try
            {
                ...
                string ToUsername = UserTable["DS_Username"].TypeString();
        ...
        public HttpResponseMessage Delete()
        {
            ...
            try
            {
                ...
                Base.Data.SqlQuery("Delete From DS_User_Bind Where DS_UserId = " + Id, ref Conn);
        ...
        {
            string Json = Base.Data.SqlListToJson("Select DS_Id, DS_DepartmentId, DS_RoleId, DS_Username, DS_Title, DS_Status, DS_Recycle From DS_User Where DS_Status = 0 And DS_Recycle = 0 Order By DS_Username Asc, DS_Id Asc", ref Conn);

            string ScriptPath = Base.Common.PathCombine(AppConfig.DataStoragePath, "user-data-json.js");
