...
namespace dboxShare.Web.Admin.Controllers
{
    ...
    public class DepartmentListJsonController : ApiController
    {
        ...
        public HttpResponseMessage ListJson()
        {
            ...
            try
            {
                ...
                string Sql = "Select DS_Id, DS_DepartmentId, DS_Name, DS_Sequence From DS_Department Where DS_DepartmentId = " + DepartmentId + " Order By DS_Sequence Desc, DS_Id Asc";
