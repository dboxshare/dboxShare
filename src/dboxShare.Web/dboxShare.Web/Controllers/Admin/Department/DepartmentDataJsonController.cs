...
namespace dboxShare.Web.Admin.Controllers
{
    ...
    public class Admin_DepartmentDataJsonController : ApiController
    {
        ...
        public HttpResponseMessage DataJson()
        {
            ...
            try
            {
                ...
                var Json = Base.Data.SqlDataToJson("Select DS_Id, DS_DepartmentId, DS_Name From DS_Department Where DS_Id = " + Id, ref Conn);
