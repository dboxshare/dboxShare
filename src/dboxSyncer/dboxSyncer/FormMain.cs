    ...
    public partial class FormMain : Form
    {
        ...
        private void LoginKeeping()
        {
            ...
            try
            {
                ...
                string PostUrl = "" + AppConfig.ServerHost + "/api/sync/user-login?timestamp=" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff") + "";
                string PostString = "loginid=" + HttpUtility.UrlEncode(AppConfig.LoginId) + "&password=" + HttpUtility.UrlEncode(AppConfig.Password) + "";
        ...
        private void ListViewDataLoad()
        {
            ...
            {
                ListViewItem ViewItem = new ListViewItem(XNode.SelectSingleNode("localFolderPath").InnerText);
        ...
        private void ButtonDelete_Click(object sender, EventArgs e)
        {
            ...
            XmlNode XNodes = XDocument.SelectSingleNode("rules");
            ...
            if (AppCommon.IsNothing(XNodes) == false)
            {
                ...
                int Item = listViewData.SelectedItems[listViewData.SelectedItems.Count - 1].Index;
                int Index = 0;
        ...
        private void ButtonSetting_Click(object sender, EventArgs e)
        {
            ...
            XmlNode XNode = (XmlNode)XDocument.SelectSingleNode(XPath.Replace("{key}", "IntervalTime"));
        ...
        {
            Process.Start(AppConfig.ServerHost);
        }
        ...
        private void LoadLanguage(ref Hashtable LangTable)
        {
            ...
            XmlNode XNodes = XDocument.SelectSingleNode("/language/formMain");
