...
namespace dboxShare.Base
{
    ...
    public static class Common
    {
        ...
        public static bool IsNumeric(object Object)
        {
            try
            {
                var Numeric = System.Convert.ToInt64(Object);
        ...
        {
            var ClientIP = Common.ClientIP();
            var ClientPC = Environment.MachineName;
            var ClientUser = Environment.UserName;
            var ClientDomain = Environment.UserDomainName;
        ...
        public static string JsonEscape(string Content)
        {
            ...
            {
                var Character = Content.ToCharArray()[i].TypeChar();
        ...
        public static bool ProcessExists(string Keys)
        {
            ...
            foreach (var ProcessItem in Process.GetProcesses())
            {
                for (var i = 0; i < Items.Length; i++)
                {
