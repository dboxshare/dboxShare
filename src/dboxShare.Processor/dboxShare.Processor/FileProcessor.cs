...
namespace dboxShare
{
    ...
    sealed class FileProcessor
    {
        ...
        public static void Main()
        {
            ...
            string MonitorFilePath = Base.Common.PathCombine(FileStoragePath, ".processing");

            DateTime PastWriteTime = File.GetLastWriteTime(MonitorFilePath);

            do
            {
                Thread.Sleep(10000);

                DateTime LastWriteTime = File.GetLastWriteTime(MonitorFilePath);
        ...
        private static void FileEncryption(string SourceFilePath, string CodeId)
        {
            ...
            string PDFFilePath = "" + SourceFilePath + ".pdf";
            ...
            string FLVFilePath = "" + SourceFilePath + ".flv";
