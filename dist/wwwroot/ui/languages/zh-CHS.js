...
lang.file = {
    ...
    'tips' : {
        ...
        'unexist-or-error' : '数据不存在或错误', 
        'operation-failed' : '操作失败', 
        'recycle-note' : '温馨提示：移除少于 30 天的共享项目不允许彻底删除；'
        }, 
...
lang.task = {
    ...
    'tips' : {
        ...
        'value' : {
            'content' : '500 个字符以内', 
            'cause' : '请输入撤消原因(必填)<br />200 个字符以内', 
            'reason' : '请输入拒绝原因(必填)<br />200 个字符以内', 
            'remark' : '请输入完成备注(可选)<br />200 个字符以内'
        }, 
        'input' : {
            'id' : 'Id 错误或非法操作', 
            'content' : '内容空值或长度超出限制', 
            'cause' : '撤消原因空值或长度超出限制', 
            'reason' : '拒绝原因空值或长度超出限制', 
            'remark' : '完成备注空值或长度超出限制'
            }, 
        'please-select-user' : '请选择用户', 
    ...
    'config' : {
        ...
        'tips' : {
            ...
            'input' : {
                ...
                'upload-size-range' : '上传大小限制数值范围 1~2048', 
